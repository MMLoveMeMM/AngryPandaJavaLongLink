...
public class CRC16 {
	...
	/*
	 * 
	 * // 0x02 05 00 03 FF 00 , crc16=7C 09 int crc = CRC16.calcCrc16(new byte[]
	 * { 0x02, 0x05, 0x00, 0x03, (byte) 0xff, 0x00 });
	 ...
	 * 客户指定crc16
	 * */
	public static short checkByBit(byte[] buffer,int offset,int count){
		short initValue = 0x0;
		short polynomial=(short) 0xA001;
		
		for(int i=offset;i<count+offset;i++)
		{
			initValue=(short)(initValue^buffer[i]);
			for(int j=0;j<8;j++)
			{
				int msbInfo=initValue&0x0001;
				initValue=(short)(initValue>>1);
				if(msbInfo!=0)
				{
					initValue = (short)(initValue ^polynomial);
				}
			}
		}
		return initValue;
